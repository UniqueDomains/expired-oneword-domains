# Expired One-Word Domains (2,817)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-2%2C817%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **2,817 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 2,817 domains · **Median ask:** $2,413.53 · **High-demand under $2,500:** 10
...
| ---------------- | ------- | --------- | ------------- | -------------- | ------ | ------ | ---------------------------------------------------------------------- |
| enjoy.sex        | expired | —         | —             | high           | medium | 5      | Dynadot Inc                                                            |
| knob.us          | expired | —         | —             | high           | high   | 4      | GoDaddy.com, LLC                                                       |
| heroine.us       | expired | —         | —             | high           | high   | 7      | Dynadot Inc                                                            |
| enjoy.biz        | expired | —         | —             | high           | medium | 5      | Spaceship, Inc.                                                        |
| precedent.us     | expired | —         | —             | high           | medium | 9      | Sav.com, LLC - 3                                                       |
| truth.mx         | expired | —         | —             | high           | medium | 5      | Namecheap, Inc.                                                        |
| narrative.at     | expired | —         | —             | high           | low    | 9      | Key-Systems GmbH ( https://nic.at/registrar/404 )                      |
| reader.one       | expired | —         | —             | high           | low    | 6      | Dynadot Inc                                                            |
| soul.biz         | expired | —         | —             | high           | medium | 4      | NameCheap, Inc.                                                        |
| career.miami     | expired | —         | —             | high           | low    | 6      | NameCheap, Inc.                                                        |
| adventure.webcam | expired | —         | —             | high           | medium | 9      | Name.com, Inc.                                                         |
| economy.net      | expired | —         | —             | high           | low    | 7      | Key-Systems GmbH                                                       |
| community.ink    | expired | —         | —             | high           | medium | 9      | Sav.com, LLC - 4                                                       |
| change.wiki      | expired | —         | —             | high           | medium | 6      | Spaceship, Inc.                                                        |
| watson.health    | expired | —         | —             | high           | medium | 6      | Spaceship, Inc.                                                        |
| damn.so          | expired | $64.98    | —             | high           | low    | 4      | namecheap                                                              |
| gels.so          | expired | $68.98    | —             | high           | low    | 4      | namecheap                                                              |
| doubt.eu         | expired | $1,366.91 | —             | high           | low    | 5      | Name: Realtime Register B.V. Website: https://www.realtimeregister.com |
| hence.eu         | expired | $4,019.25 | $4,019.25     | high           | low    | 5      | Name: Realtime Register B.V. Website: https://www.realtimeregister.com |
| adapts.so        | expired | $68.98    | —             | high           | medium | 6      | namecheap                                                              |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 2,817 live domains                         |
...
> Unique Domains. *Expired One-Word Domains*. Version 2026-09-25. Public GitHub extract for the exact Unique Domains search represented by this repository.
