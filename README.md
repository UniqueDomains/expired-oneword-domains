# Expired One-Word Domains (60,121)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-60%2C121%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **60,121 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 60,121 domains · **Median ask:** $3,978.39 · **High-demand under $2,500:** 167
...
This repository is the public extract for the exact Unique Domains search represented by `https://unique.domains/domains/expired`.

### Files

- `expired.csv`, public CSV extract (1,000 rows)
- `expired.json`, public JSON extract (1,000 rows)
...
df = pd.read_csv("https://raw.githubusercontent.com/UniqueDomains/expired-oneword-domains/main/expired.csv")
print(df.head())
```
...
| ------------------- | ------- | ---------- | ------------- | -------------- | ------ | ------ | ------------------------------------------------------- |
| advise.app          | expired | $5,173.85  | $123.75       | high           | high   | 6      | united-domains AG                                       |
| markets.cv          | expired | $1,309.75  | $19.50        | medium         | low    | 7      | namecheap                                               |
| cardigans.io        | expired | $44.99     | $73.99        | medium         | low    | 9      | Sav.com, LLC                                            |
| aborticide.com      | expired | $8,625     | $19.99        | medium         | low    | 10     | NameCheap, Inc.                                         |
| exhibition.info     | expired | $10,527.84 | —             | high           | low    | 10     | Virtualia LLC                                           |
| allterrain.io       | expired | $44.99     | $73.99        | medium         | high   | 11     | Sav.com, LLC                                            |
| allthesame.io       | expired | $44.99     | $73.99        | medium         | high   | 12     | Key-Systems GmbH                                        |
| aesthetically.co    | expired | $17.99     | $48.99        | medium         | high   | 13     | GoDaddy.com, LLC                                        |
| alphabetsoup.cloud  | expired | $32.98     | —             | medium         | high   | 13     | IONOS SE                                                |
| computerlanguage.it | expired | $25.99     | —             | high           | low    | 17     | name.com                                                |
| age.vip             | expired | —          | —             | high           | low    | 3      | Alibaba Cloud Computing Ltd. d/b/a HiChina (www.net.cn) |
| aid.legal           | expired | —          | —             | medium         | low    | 3      | united-domains GmbH                                     |
| aim.studio          | expired | —          | —             | high           | medium | 3      | NameCheap, Inc.                                         |
| air.casa            | expired | —          | —             | high           | medium | 3      | NameCheap, Inc.                                         |
| all.fashion         | expired | —          | —             | high           | medium | 3      | Spaceship, Inc.                                         |
| ana.it              | expired | —          | —             | high           | low    | 3      | —                                                       |
| ant.black           | expired | —          | —             | high           | medium | 3      | GoDaddy.com, LLC                                        |
| aww.gg              | expired | —          | —             | high           | high   | 3      | Porkbun LLC (https://porkbun.com/)                      |
| bid.it              | expired | —          | —             | high           | low    | 3      | —                                                       |
| boo.bio             | expired | —          | —             | medium         | low    | 3      | Hosting Concepts B.V. d/b/a Registrar.eu                |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 60,121 live domains                        |
| Static CSV / JSON       | live search and daily refresh              |
| Basic exported fields   | 167 high-demand names under $2,500         |
...
These are expired one-word domains pulled from 506 different TLDs, ranging from short brandable names to niche sector terms. Pricing skews wide: the bulk sit under $500, while a smaller group asks $10k or more, with a median ask of $3,961 across the full set. TLD coverage leans toward .it, .us, .store, .co, and .online, alongside app-focused extensions like .app and .site. Demand scoring shows most names in the low tier, but a meaningful slice — over 11,000 — score high or top 15%, which is where the sharper picks tend to sit.

- 51,253 expired one-word names, median ask $3,961
- 506 TLDs covered, led by .it, .us, .store, .co
- 11,662 names score high or top-15% on demand
- Undervalued picks found under $150 with 80+ demand scores
...
> Unique Domains. *Expired One-Word Domains*. Version 2026-09-14. Public GitHub extract for the exact Unique Domains search represented by this repository.
